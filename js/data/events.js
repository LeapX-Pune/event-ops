export const events = [
  ...
  { id: 'evt_033', title: 'Symphony in the Park', description: 'A beautiful evening of classical music in the open air.', category: 'cat_music', date: '2026-08-15', time: '18:00', location: 'Central Park, NY', image: 'assets/images/events/evt_033.jpg', price: '$20', attendees: 1200, maxAttendees: 2000 },
  { id: 'evt_034', title: 'Electronic Music Festival', description: 'Experience the best DJs from around the world.', category: 'cat_music', date: '2026-09-10', time: '14:00', location: 'Ibiza, Spain', image: 'assets/images/events/evt_034.jpg', price: '$150', attendees: 5000, maxAttendees: 10000 },
  { id: 'evt_035', title: 'Jazz Night', description: 'Smooth jazz vibes in an intimate setting.', category: 'cat_music', date: '2026-10-05', time: '20:00', location: 'New Orleans, LA', image: 'assets/images/events/evt_035.jpg', price: '$40', attendees: 150, maxAttendees: 200 },
  { id: 'evt_036', title: 'Rock & Roll Arena', description: 'Legendary rock bands perform live.', category: 'cat_music', date: '2026-11-20', time: '19:30', location: 'London, UK', image: 'assets/images/events/evt_036.jpg', price: '$80', attendees: 8000, maxAttendees: 15000 },
  { id: 'evt_037', title: 'Classical Piano Recital', description: 'An elegant showcase of piano masterpieces.', category: 'cat_music', date: '2026-12-01', time: '17:00', location: 'Vienna, Austria', image: 'assets/images/events/evt_037.jpg', price: '$60', attendees: 400, maxAttendees: 500 },
  { id: 'evt_038', title: 'Marathon City', description: 'Join thousands of runners in the annual city marathon.', category: 'cat_sports', date: '2026-09-25', time: '06:00', location: 'Boston, MA', image: 'assets/images/events/evt_038.jpg', price: '$100', attendees: 25000, maxAttendees: 30000 },
  { id: 'evt_039', title: 'Championship Tennis', description: 'Watch the best tennis players compete for the title.', category: 'cat_sports', date: '2026-07-10', time: '10:00', location: 'Wimbledon, UK', image: 'assets/images/events/evt_039.jpg', price: '$200', attendees: 15000, maxAttendees: 15000 },
  { id: 'evt_040', title: 'World Cup Football', description: 'The grand finale of the football world cup.', category: 'cat_sports', date: '2026-08-20', time: '15:00', location: 'Rio, Brazil', image: 'assets/images/events/evt_040.jpg', price: '$300', attendees: 80000, maxAttendees: 80000 },
  { id: 'evt_041', title: 'Extreme X-Games', description: 'Adrenaline-pumping extreme sports action.', category: 'cat_sports', date: '2027-01-15', time: '09:00', location: 'Aspen, CO', image: 'assets/images/events/evt_041.jpg', price: '$50', attendees: 5000, maxAttendees: 8000 },
  { id: 'evt_042', title: 'Pro Basketball Finals', description: 'Courtside action at the biggest basketball event.', category: 'cat_sports', date: '2027-06-05', time: '20:30', location: 'Los Angeles, CA', image: 'assets/images/events/evt_042.jpg', price: '$250', attendees: 18000, maxAttendees: 20000 },
  { id: 'evt_043', title: 'Modern Art Expo', description: 'Discover cutting-edge modern artworks.', category: 'cat_art', date: '2026-10-12', time: '11:00', location: 'Paris, France', image: 'assets/images/events/evt_043.jpg', price: '$25', attendees: 3000, maxAttendees: 5000 },
  { id: 'evt_044', title: 'Sculpture Walk', description: 'An outdoor exhibition of contemporary sculptures.', category: 'cat_art', date: '2026-11-05', time: '10:00', location: 'Florence, Italy', image: 'assets/images/events/evt_044.jpg', price: 'Free', attendees: 1500, maxAttendees: 3000 },
  { id: 'evt_045', title: 'Digital Art Fair', crypto: true, description: 'NFTs, VR experiences, and digital masterpieces.', category: 'cat_art', date: '2027-02-20', time: '12:00', location: 'Tokyo, Japan', image: 'assets/images/events/evt_045.jpg', price: '$35', attendees: 4000, maxAttendees: 5000 },
  { id: 'evt_046', title: 'Renaissance Canvas', description: 'A curated collection of classical paintings.', category: 'cat_art', date: '2027-03-15', time: '09:00', location: 'Rome, Italy', image: 'assets/images/events/evt_046.jpg', price: '$20', attendees: 2000, maxAttendees: 2500 },
  { id: 'evt_047', title: 'Abstract Exhibition', description: 'Dive deep into the world of abstract expressionism.', category: 'cat_art', date: '2027-05-10', time: '10:30', location: 'Berlin, Germany', image: 'assets/images/events/evt_047.jpg', price: '$15', attendees: 1200, maxAttendees: 2000 },
  { id: 'evt_048', title: 'Startup Pitch Deck', description: 'Innovative startups pitch to top-tier investors.', category: 'cat_business', date: '2026-11-15', time: '09:00', location: 'Silicon Valley, CA', image: 'assets/images/events/evt_048.jpg', price: '$50', attendees: 500, maxAttendees: 800 },
  { id: 'evt_049', title: 'Global FinTech Summit', description: 'The future of finance and blockchain technology.', category: 'cat_business', date: '2027-04-10', time: '08:00', location: 'Singapore', image: 'assets/images/events/evt_049.jpg', price: '$300', attendees: 1200, maxAttendees: 1500 },
  { id: 'evt_050', title: 'Leadership Conference', description: 'Inspiring keynotes from industry titans.', category: 'cat_business', date: '2027-06-25', time: '10:00', location: 'New York, NY', image: 'assets/images/events/evt_050.jpg', price: '$150', attendees: 800, maxAttendees: 1000 },
  { id: 'evt_051', title: 'E-commerce Expo', description: 'The latest trends and tools for online retail.', category: 'cat_business', date: '2027-08-12', time: '09:30', location: 'London, UK', image: 'assets/images/events/evt_051.jpg', price: '$75', attendees: 2000, maxAttendees: 3000 },
  { id: 'evt_052', title: 'Real Estate Seminar', description: 'Insights into global property markets and investing.', category: 'cat_business', date: '2027-09-05', time: '11:00', location: 'Dubai, UAE', image: 'assets/images/events/evt_052.jpg', price: '$100', attendees: 600, maxAttendees: 1000 },
  { id: 'evt_053', title: 'Gourmet Street Food', description: 'A culinary journey through international street food.', category: 'cat_food', date: '2026-10-20', time: '17:00', location: 'Bangkok, Thailand', image: 'assets/images/events/evt_053.jpg', price: '$10', attendees: 4000, maxAttendees: 6000 },
  { id: 'evt_054', title: 'Wine Tasting Masterclass', description: 'Sample the finest vintages with expert sommeliers.', category: 'cat_food', date: '2026-11-12', time: '15:00', location: 'Bordeaux, France', image: 'assets/images/events/evt_054.jpg', price: '$120', attendees: 100, maxAttendees: 150 },
  { id: 'evt_055', title: 'Vegan Culinary Fest', description: 'The best plant-based dishes from top chefs.', category: 'cat_food', date: '2027-01-08', time: '11:00', location: 'Los Angeles, CA', image: 'assets/images/events/evt_055.jpg', price: '$25', attendees: 2000, maxAttendees: 3000 },
  { id: 'evt_056', title: 'International Baking Expo', description: 'Discover new techniques, ingredients, and sweet treats.', category: 'cat_food', date: '2027-03-22', time: '09:00', location: 'Paris, France', image: 'assets/images/events/evt_056.jpg', price: '$40', attendees: 1500, maxAttendees: 2500 },
  { id: 'evt_057', title: 'Seafood & Grill Fest', description: 'Fresh catch and barbecue by the beach.', category: 'cat_food', date: '2027-05-18', time: '12:00', location: 'Sydney, Australia', image: 'assets/images/events/evt_057.jpg', price: '$35', attendees: 3000, maxAttendees: 5000 },
  { id: 'evt_058', title: 'Wellness Retreat', description: 'Recharge your mind and body in a serene environment.', category: 'cat_health', date: '2026-12-05', time: '08:00', location: 'Bali, Indonesia', image: 'assets/images/events/evt_058.jpg', price: '$500', attendees: 50, maxAttendees: 80 },
  { id: 'evt_059', title: 'Global Yoga Summit', description: 'Join leading yogis for a weekend of practice and meditation.', category: 'cat_health', date: '2027-02-14', time: '06:30', location: 'Rishikesh, India', image: 'assets/images/events/evt_059.jpg', price: '$150', attendees: 500, maxAttendees: 1000 },
  { id: 'evt_060', title: 'Future of Medicine', description: 'Explore breakthroughs in healthcare and biotechnology.', category: 'cat_health', date: '2027-04-20', time: '09:00', location: 'Boston, MA', image: 'assets/images/events/evt_060.jpg', price: '$200', attendees: 800, maxAttendees: 1200 },
  { id: 'evt_061', title: 'Mental Health Symposium', description: 'Conversations on well-being and psychological resilience.', category: 'cat_health', date: '2027-07-11', time: '10:00', location: 'Toronto, Canada', image: 'assets/images/events/evt_061.jpg', price: '$80', attendees: 400, maxAttendees: 600 },
  { id: 'evt_062', title: 'Holistic Nutrition Fair', description: 'Learn about superfoods, organic diets, and healthy living.', category: 'cat_health', date: '2027-09-22', time: '11:00', location: 'Amsterdam, Netherlands', image: 'assets/images/events/evt_062.jpg', price: '$30', attendees: 1500, maxAttendees: 2000 },
  { id: 'evt_063', title: 'EdTech Conference', description: 'The intersection of technology and modern education.', category: 'cat_edu', date: '2026-11-28', time: '09:00', location: 'London, UK', image: 'assets/images/events/evt_063.jpg', price: '$120', attendees: 1000, maxAttendees: 1500 },
  { id: 'evt_064', title: 'University Open Day', description: 'Explore campus life and academic programs.', category: 'cat_edu', date: '2027-01-20', time: '10:00', location: 'Oxford, UK', image: 'assets/images/events/evt_064.jpg', price: 'Free', attendees: 5000, maxAttendees: 8000 },
  { id: 'evt_065', title: 'Language Learning Summit', description: 'Mastering new languages with polyglots and experts.', category: 'cat_edu', date: '2027-03-12', time: '09:30', location: 'Madrid, Spain', image: 'assets/images/events/evt_065.jpg', price: '$60', attendees: 600, maxAttendees: 1000 },
  { id: 'evt_066', title: 'Science & Tech Fair', description: 'Student projects and innovations in STEM.', category: 'cat_edu', date: '2027-05-08', time: '08:30', location: 'MIT, MA', image: 'assets/images/events/evt_066.jpg', price: 'Free', attendees: 2000, maxAttendees: 3000 },
  { id: 'evt_067', title: 'Creative Writing Workshop', description: 'Hone your storytelling skills with bestselling authors.', category: 'cat_edu', date: '2027-08-19', time: '14:00', location: 'Dublin, Ireland', image: 'assets/images/events/evt_067.jpg', price: '$90', attendees: 150, maxAttendees: 200 }
];
